jQuery( document ).ready( function ( $ ) {
	...
	*/
    // quality slider
    $( '#quality_crfi_span' ).slider( {
		value: $( '#quality_crfi_input' ).val(),
		min: 0,
		max: 100,
		step: 1,
		orientation: 'horizontal',
		slide: function ( e, ui ) {
			$( '#quality_crfi_input' ).attr( 'value', ui.value );
			$( '#quality_crfi_span' ).attr( 'title', ui.value );
    ...
    // opacity slider
    $( '#opacity_crfi_span' ).slider( {
		value: $( '#opacity_crfi_input' ).val(),
		min: 0,
		max: 100,
		step: 1,
		orientation: 'horizontal',
		slide: function ( e, ui ) {
			$( '#opacity_crfi_input' ).attr( 'value', ui.value );
			$( '#opacity_crfi_span' ).attr( 'title', ui.value );
